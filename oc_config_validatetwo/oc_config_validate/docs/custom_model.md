## Using a custom binding in oc_config_validatetwo
...
This makes sense.  The init configuration has [SSIDs configured](https://github.com/google/gnxi/blob/master/oc_config_validatetwo/init_configs/ap.json),
...
An example of generating the binding is on [update_models.sh](https://github.com/google/gnxi/blob/master/oc_config_validatetwo/oc_config_validatetwo/update_models.sh#L43)

Notice how in addition to [wifi.py](https://github.com/google/gnxi/blob/master/oc_config_validatetwo/oc_config_validatetwo/models/wifi.py)
 we also generate [wifi_arista.py](https://github.com/google/gnxi/blob/master/oc_config_validatetwo/oc_config_validatetwo/models/wifi_arista.py)
