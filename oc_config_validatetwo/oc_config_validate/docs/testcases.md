## How to create oc_config_validatetwo testcases

`oc_config_validatetwo` executes the Python classes in the `oc_config_validatetwo.testcases` module.
...
```
from oc_config_validatetwo import test_base
from oc_config_validatetwo.models import openconfig_model
 ...
 * The OpenConfig models, in Python classes, can be imported from `oc_config_validatetwo.models` package.
...
> Some testcases for simple gNMI GET and SET tests are already provided for use in the `oc_config_validatetwo.testcases` module.
