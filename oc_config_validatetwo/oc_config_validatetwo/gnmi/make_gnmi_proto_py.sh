...
sed -i 's/import gnmi_ext_pb2/from oc_config_validatetwo.gnmi import gnmi_ext_pb2/' "${GNMI_FOLDER}/gnmi_pb2.py"
sed -i 's/import gnmi_pb2 /from oc_config_validatetwo.gnmi import gnmi_pb2 /' "${GNMI_FOLDER}/gnmi_pb2_grpc.py"
