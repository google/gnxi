...
class yc_config_openconfig_defined_sets__defined_sets_ipv4_prefix_sets_ipv4_prefix_set_config(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__name','__description','__prefix','__exclude_prefix',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__exclude_prefix = YANGDynClass(unique=True, base=TypedListType(allowed_type=RestrictedClassType(base_type=str, restriction_dict={'pattern': '([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])(\\.([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])){3}/([0-9]|[12][0-9]|3[0-2])'})), is_leaf=False, yang_name="exclude-prefix", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/defined-sets', defining_module='openconfig-defined-sets', yang_type='oc-inet:ipv4-prefix', is_config=True)
...
unless they also fall within any of the 'exclude-prefix' entries.
  ...
  def _get_exclude_prefix(self):
    """
    Getter method for exclude_prefix, mapped from YANG variable /defined_sets/ipv4_prefix_sets/ipv4_prefix_set/config/exclude_prefix (oc-inet:ipv4-prefix)

    YANG Description: A user-defined list of IPv4 prefixes to be excluded from the
...
that are not in 'exclude-prefix'.
    """
    return self.__exclude_prefix
      
  def _set_exclude_prefix(self, v, load=False):
    """
    Setter method for exclude_prefix, mapped from YANG variable /defined_sets/ipv4_prefix_sets/ipv4_prefix_set/config/exclude_prefix (oc-inet:ipv4-prefix)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_exclude_prefix is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_exclude_prefix() directly.
...
that are not in 'exclude-prefix'.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """exclude_prefix must be of a type compatible with oc-inet:ipv4-prefix""",
          'defined-type': "oc-inet:ipv4-prefix",
          'generated-type': """YANGDynClass(unique=True, base=TypedListType(allowed_type=RestrictedClassType(base_type=str, restriction_dict={'pattern': '([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])(\\.([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])){3}/([0-9]|[12][0-9]|3[0-2])'})), is_leaf=False, yang_name="exclude-prefix", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/defined-sets', defining_module='openconfig-defined-sets', yang_type='oc-inet:ipv4-prefix', is_config=True)""",
        })

    self.__exclude_prefix = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_exclude_prefix(self):
    self.__exclude_prefix = YANGDynClass(unique=True, base=TypedListType(allowed_type=RestrictedClassType(base_type=str, restriction_dict={'pattern': '([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])(\\.([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])){3}/([0-9]|[12][0-9]|3[0-2])'})), is_leaf=False, yang_name="exclude-prefix", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/defined-sets', defining_module='openconfig-defined-sets', yang_type='oc-inet:ipv4-prefix', is_config=True)

  name = __builtin__.property(_get_name, _set_name)
  description = __builtin__.property(_get_description, _set_description)
  prefix = __builtin__.property(_get_prefix, _set_prefix)
  exclude_prefix = __builtin__.property(_get_exclude_prefix, _set_exclude_prefix)


  _pyangbind_elements = OrderedDict([('name', name), ('description', description), ('prefix', prefix), ('exclude_prefix', exclude_prefix), ])
...
unless they also fall within any of the 'exclude-prefix' entries.
  ...
  def _get_exclude_prefix(self):
    """
    Getter method for exclude_prefix, mapped from YANG variable /defined_sets/ipv4_prefix_sets/ipv4_prefix_set/state/exclude_prefix (oc-inet:ipv4-prefix)
...
that are not in 'exclude-prefix'.
  ...
  def _set_exclude_prefix(self, v, load=False):
    """
    Setter method for exclude_prefix, mapped from YANG variable /defined_sets/ipv4_prefix_sets/ipv4_prefix_set/state/exclude_prefix (oc-inet:ipv4-prefix)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_exclude_prefix is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_exclude_prefix() directly.
...
that are not in 'exclude-prefix'.
  ...
  exclude_prefix = __builtin__.property(_get_exclude_prefix)
...
class yc_config_openconfig_defined_sets__defined_sets_ipv6_prefix_sets_ipv6_prefix_set_config(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__exclude_prefix = YANGDynClass(unique=True, base=TypedListType(allowed_type=RestrictedClassType(base_type=str, restriction_dict={'pattern': '(([0-9a-fA-F]{1,4}:){7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:))/(12[0-8]|1[0-1][0-9]|[1-9][0-9]|[0-9])'})), is_leaf=False, yang_name="exclude-prefix", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/defined-sets', defining_module='openconfig-defined-sets', yang_type='oc-inet:ipv6-prefix', is_config=True)
...
unless they also fall within any of the 'exclude-prefix' entries.
  ...
  def _get_exclude_prefix(self):
    """
    Getter method for exclude_prefix, mapped from YANG variable /defined_sets/ipv6_prefix_sets/ipv6_prefix_set/config/exclude_prefix (oc-inet:ipv6-prefix)

    YANG Description: A user-defined list of IPv6 prefixes to be excluded from the
...
that are not in 'exclude-prefix'.
  ...
  def _set_exclude_prefix(self, v, load=False):
    """
    Setter method for exclude_prefix, mapped from YANG variable /defined_sets/ipv6_prefix_sets/ipv6_prefix_set/config/exclude_prefix (oc-inet:ipv6-prefix)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_exclude_prefix is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_exclude_prefix() directly.
...
that are not in 'exclude-prefix'.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """exclude_prefix must be of a type compatible with oc-inet:ipv6-prefix""",
          'defined-type': "oc-inet:ipv6-prefix",
          'generated-type': """YANGDynClass(unique=True, base=TypedListType(allowed_type=RestrictedClassType(base_type=str, restriction_dict={'pattern': '(([0-9a-fA-F]{1,4}:){7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:))/(12[0-8]|1[0-1][0-9]|[1-9][0-9]|[0-9])'})), is_leaf=False, yang_name="exclude-prefix", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/defined-sets', defining_module='openconfig-defined-sets', yang_type='oc-inet:ipv6-prefix', is_config=True)""",
        })
...
unless they also fall within any of the 'exclude-prefix' entries.
  ...
  def _get_exclude_prefix(self):
    """
    Getter method for exclude_prefix, mapped from YANG variable /defined_sets/ipv6_prefix_sets/ipv6_prefix_set/state/exclude_prefix (oc-inet:ipv6-prefix)
...
that are not in 'exclude-prefix'.
  ...
  def _set_exclude_prefix(self, v, load=False):
    """
    Setter method for exclude_prefix, mapped from YANG variable /defined_sets/ipv6_prefix_sets/ipv6_prefix_set/state/exclude_prefix (oc-inet:ipv6-prefix)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_exclude_prefix is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_exclude_prefix() directly.
...
class yc_config_openconfig_defined_sets__defined_sets_port_sets_port_set_config(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__name','__description','__port','__exclude_port',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__exclude_port = YANGDynClass(unique=True, base=TypedListType(allowed_type=[RestrictedClassType(base_type=str, restriction_dict={'pattern': '(0{0,4}[0-9]|0{0,3}[1-9][0-9]|0{0,2}[1-9][0-9]{2}|0?[1-9][0-9]{3}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5])\\.\\.(0{0,4}[0-9]|0{0,3}[1-9][0-9]|0{0,2}[1-9][0-9]{2}|0?[1-9][0-9]{3}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5])'}),RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16),RestrictedClassType(base_type=str,                                     restriction_type="dict_key",                                     restriction_arg={'ANY': {}},),]), is_leaf=False, yang_name="exclude-port", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/defined-sets', defining_module='openconfig-defined-sets', yang_type='oc-pkt-match-types:port-num-range', is_config=True)
  ...
  def _get_port(self):
    ...
    YANG Description: A user defined set of ports to be used in the match conditions.
...
are also included in 'exclude-port'.
  ...
  def _get_exclude_port(self):
    """
    Getter method for exclude_port, mapped from YANG variable /defined_sets/port_sets/port_set/config/exclude_port (oc-pkt-match-types:port-num-range)

    YANG Description: A user-defined list of ports to be excluded from the 'port'
...
that are not in 'exclude-port'.
    """
    return self.__exclude_port
      
  def _set_exclude_port(self, v, load=False):
    """
    Setter method for exclude_port, mapped from YANG variable /defined_sets/port_sets/port_set/config/exclude_port (oc-pkt-match-types:port-num-range)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_exclude_port is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_exclude_port() directly.
...
that are not in 'exclude-port'.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """exclude_port must be of a type compatible with oc-pkt-match-types:port-num-range""",
          'defined-type': "oc-pkt-match-types:port-num-range",
          'generated-type': """YANGDynClass(unique=True, base=TypedListType(allowed_type=[RestrictedClassType(base_type=str, restriction_dict={'pattern': '(0{0,4}[0-9]|0{0,3}[1-9][0-9]|0{0,2}[1-9][0-9]{2}|0?[1-9][0-9]{3}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5])\\.\\.(0{0,4}[0-9]|0{0,3}[1-9][0-9]|0{0,2}[1-9][0-9]{2}|0?[1-9][0-9]{3}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5])'}),RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16),RestrictedClassType(base_type=str,                                     restriction_type="dict_key",                                     restriction_arg={'ANY': {}},),]), is_leaf=False, yang_name="exclude-port", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/defined-sets', defining_module='openconfig-defined-sets', yang_type='oc-pkt-match-types:port-num-range', is_config=True)""",
        })

    self.__exclude_port = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_exclude_port(self):
    self.__exclude_port = YANGDynClass(unique=True, base=TypedListType(allowed_type=[RestrictedClassType(base_type=str, restriction_dict={'pattern': '(0{0,4}[0-9]|0{0,3}[1-9][0-9]|0{0,2}[1-9][0-9]{2}|0?[1-9][0-9]{3}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5])\\.\\.(0{0,4}[0-9]|0{0,3}[1-9][0-9]|0{0,2}[1-9][0-9]{2}|0?[1-9][0-9]{3}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5])'}),RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16),RestrictedClassType(base_type=str,                                     restriction_type="dict_key",                                     restriction_arg={'ANY': {}},),]), is_leaf=False, yang_name="exclude-port", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/defined-sets', defining_module='openconfig-defined-sets', yang_type='oc-pkt-match-types:port-num-range', is_config=True)

  name = __builtin__.property(_get_name, _set_name)
  description = __builtin__.property(_get_description, _set_description)
  port = __builtin__.property(_get_port, _set_port)
  exclude_port = __builtin__.property(_get_exclude_port, _set_exclude_port)


  _pyangbind_elements = OrderedDict([('name', name), ('description', description), ('port', port), ('exclude_port', exclude_port), ])
...
are also included in 'exclude-port'.
  ...
  def _get_exclude_port(self):
    """
    Getter method for exclude_port, mapped from YANG variable /defined_sets/port_sets/port_set/state/exclude_port (oc-pkt-match-types:port-num-range)
...
that are not in 'exclude-port'.
  ...
  def _set_exclude_port(self, v, load=False):
    """
    Setter method for exclude_port, mapped from YANG variable /defined_sets/port_sets/port_set/state/exclude_port (oc-pkt-match-types:port-num-range)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_exclude_port is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_exclude_port() directly.
...
that are not in 'exclude-port'.
  ...
  exclude_port = __builtin__.property(_get_exclude_port)
