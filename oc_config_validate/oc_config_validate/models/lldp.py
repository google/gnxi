...
class yc_config_openconfig_lldp__lldp_config(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__management_interface = YANGDynClass(base=str, is_leaf=True, yang_name="management-interface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='oc-if:interface-id', is_config=True)
...
LldpChassisIdSubtype object from IEEE 802.1AB MIB.
  ...
  def _get_management_interface(self):
    """
    Getter method for management_interface, mapped from YANG variable /lldp/config/management_interface (oc-if:interface-id)

    YANG Description: The interface in which to derive the population of Management
...
choose which interface is utilized.
  ...
  def _set_management_interface(self, v, load=False):
    """
    Setter method for management_interface, mapped from YANG variable /lldp/config/management_interface (oc-if:interface-id)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_management_interface is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_management_interface() directly.
...
choose which interface is utilized.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="management-interface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='oc-if:interface-id', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """management_interface must be of a type compatible with oc-if:interface-id""",
          'defined-type': "oc-if:interface-id",
          'generated-type': """YANGDynClass(base=str, is_leaf=True, yang_name="management-interface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='oc-if:interface-id', is_config=True)""",
        })

    self.__management_interface = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_management_interface(self):
    self.__management_interface = YANGDynClass(base=str, is_leaf=True, yang_name="management-interface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='oc-if:interface-id', is_config=True)
...
class yc_counters_openconfig_lldp__lldp_state_counters(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__last_clear = YANGDynClass(base=RestrictedClassType(base_type=str, restriction_dict={'pattern': '[0-9]{4}\\-(0[1-9]|1[0-2])\\-(0[1-9]|[12][0-9]|3[01])[Tt](0[0-9]|1[0-9]|2[0-3]):(0[0-9]|[1-5][0-9]):(0[0-9]|[1-5][0-9]|60)(\\.[0-9]+)?([Zz]|([+-](0[0-9]|1[0-9]|2[0-3]):(0[0-9]|[1-5][0-9])))'}), is_leaf=True, yang_name="last-clear", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='oc-yang:date-and-time', is_config=False)
  ...
  def _get_frame_in(self):
    """
    Getter method for frame_in, mapped from YANG variable /lldp/state/counters/frame_in (oc-yang:counter64)
  ...
  def _set_frame_in(self, v, load=False):
    """
    Setter method for frame_in, mapped from YANG variable /lldp/state/counters/frame_in (oc-yang:counter64)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """frame_in must be of a type compatible with oc-yang:counter64""",
  ...
  def _get_frame_out(self):
    """
    Getter method for frame_out, mapped from YANG variable /lldp/state/counters/frame_out (oc-yang:counter64)
  ...
  def _set_frame_out(self, v, load=False):
    """
    Setter method for frame_out, mapped from YANG variable /lldp/state/counters/frame_out (oc-yang:counter64)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """frame_out must be of a type compatible with oc-yang:counter64""",
          'defined-type': "oc-yang:counter64",
  ...
  def _get_frame_error_in(self):
    """
    Getter method for frame_error_in, mapped from YANG variable /lldp/state/counters/frame_error_in (oc-yang:counter64)
  ...
  def _set_frame_error_in(self, v, load=False):
    """
    Setter method for frame_error_in, mapped from YANG variable /lldp/state/counters/frame_error_in (oc-yang:counter64)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """frame_error_in must be of a type compatible with oc-yang:counter64""",
          'defined-type': "oc-yang:counter64",
  ...
  def _get_frame_discard(self):
    """
    Getter method for frame_discard, mapped from YANG variable /lldp/state/counters/frame_discard (oc-yang:counter64)
  ...
  def _set_frame_discard(self, v, load=False):
    """
    Setter method for frame_discard, mapped from YANG variable /lldp/state/counters/frame_discard (oc-yang:counter64)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """frame_discard must be of a type compatible with oc-yang:counter64""",
          'defined-type': "oc-yang:counter64",
  ...
  def _get_tlv_discard(self):
    """
    Getter method for tlv_discard, mapped from YANG variable /lldp/state/counters/tlv_discard (oc-yang:counter64)
  ...
  def _set_tlv_discard(self, v, load=False):
    """
    Setter method for tlv_discard, mapped from YANG variable /lldp/state/counters/tlv_discard (oc-yang:counter64)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """tlv_discard must be of a type compatible with oc-yang:counter64""",
          'defined-type': "oc-yang:counter64",
  ...
  def _get_tlv_unknown(self):
    """
    Getter method for tlv_unknown, mapped from YANG variable /lldp/state/counters/tlv_unknown (oc-yang:counter64)
  ...
  def _set_tlv_unknown(self, v, load=False):
    """
    Setter method for tlv_unknown, mapped from YANG variable /lldp/state/counters/tlv_unknown (oc-yang:counter64)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """tlv_unknown must be of a type compatible with oc-yang:counter64""",
          'defined-type': "oc-yang:counter64",
  ...
  def _get_last_clear(self):
    """
    Getter method for last_clear, mapped from YANG variable /lldp/state/counters/last_clear (oc-yang:date-and-time)
...
cleared.
  ...
  def _set_last_clear(self, v, load=False):
    """
    Setter method for last_clear, mapped from YANG variable /lldp/state/counters/last_clear (oc-yang:date-and-time)
    If this variable is read-only (config: false) in the
...
cleared.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=str, restriction_dict={'pattern': '[0-9]{4}\\-(0[1-9]|1[0-2])\\-(0[1-9]|[12][0-9]|3[01])[Tt](0[0-9]|1[0-9]|2[0-3]):(0[0-9]|[1-5][0-9]):(0[0-9]|[1-5][0-9]|60)(\\.[0-9]+)?([Zz]|([+-](0[0-9]|1[0-9]|2[0-3]):(0[0-9]|[1-5][0-9])))'}), is_leaf=True, yang_name="last-clear", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='oc-yang:date-and-time', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """last_clear must be of a type compatible with oc-yang:date-and-time""",
          'defined-type': "oc-yang:date-and-time",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=str, restriction_dict={'pattern': '[0-9]{4}\\-(0[1-9]|1[0-2])\\-(0[1-9]|[12][0-9]|3[01])[Tt](0[0-9]|1[0-9]|2[0-3]):(0[0-9]|[1-5][0-9]):(0[0-9]|[1-5][0-9]|60)(\\.[0-9]+)?([Zz]|([+-](0[0-9]|1[0-9]|2[0-3]):(0[0-9]|[1-5][0-9])))'}), is_leaf=True, yang_name="last-clear", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='oc-yang:date-and-time', is_config=False)""",
        })
  ...
  def _get_tlv_accepted(self):
    """
    Getter method for tlv_accepted, mapped from YANG variable /lldp/state/counters/tlv_accepted (oc-yang:counter64)
  ...
  def _set_tlv_accepted(self, v, load=False):
    """
    Setter method for tlv_accepted, mapped from YANG variable /lldp/state/counters/tlv_accepted (oc-yang:counter64)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """tlv_accepted must be of a type compatible with oc-yang:counter64""",
          'defined-type': "oc-yang:counter64",
  ...
  def _get_entries_aged_out(self):
    """
    Getter method for entries_aged_out, mapped from YANG variable /lldp/state/counters/entries_aged_out (oc-yang:counter64)
  ...
  def _set_entries_aged_out(self, v, load=False):
    """
    Setter method for entries_aged_out, mapped from YANG variable /lldp/state/counters/entries_aged_out (oc-yang:counter64)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """entries_aged_out must be of a type compatible with oc-yang:counter64""",
          'defined-type': "oc-yang:counter64",
...
class yc_state_openconfig_lldp__lldp_state(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__management_interface = YANGDynClass(base=str, is_leaf=True, yang_name="management-interface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='oc-if:interface-id', is_config=False)
...
LldpChassisIdSubtype object from IEEE 802.1AB MIB.
  ...
  def _get_management_interface(self):
    """
    Getter method for management_interface, mapped from YANG variable /lldp/state/management_interface (oc-if:interface-id)
...
choose which interface is utilized.
  ...
  def _set_management_interface(self, v, load=False):
    """
    Setter method for management_interface, mapped from YANG variable /lldp/state/management_interface (oc-if:interface-id)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_management_interface is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_management_interface() directly.
...
choose which interface is utilized.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="management-interface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='oc-if:interface-id', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """management_interface must be of a type compatible with oc-if:interface-id""",
          'defined-type': "oc-if:interface-id",
          'generated-type': """YANGDynClass(base=str, is_leaf=True, yang_name="management-interface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='oc-if:interface-id', is_config=False)""",
        })
  ...
  management_interface = __builtin__.property(_get_management_interface)
...
class yc_state_openconfig_lldp__lldp_mgmt_addresses_mgmt_address_state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-lldp - based on the path /lldp/mgmt-addresses/mgmt-address/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Operational state data for management addresses
  """
  __slots__ = ('_path_helper', '_extmethods', '__address','__interface_number','__interface_number_subtype',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__address = YANGDynClass(base=[RestrictedClassType(base_type=str, restriction_dict={'pattern': '([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])(\\.([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])){3}'}),RestrictedClassType(base_type=str, restriction_dict={'pattern': '(([0-9a-fA-F]{1,4}:){7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:))'}),RestrictedClassType(base_type=str, restriction_dict={'pattern': '[0-9a-fA-F]{2}(:[0-9a-fA-F]{2}){5}'}),], is_leaf=True, yang_name="address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='union', is_config=False)
    self.__interface_number = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="interface-number", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='uint32', is_config=False)
    self.__interface_number_subtype = YANGDynClass(base=RestrictedClassType(base_type=str,                                     restriction_type="dict_key",                                     restriction_arg={'UNKNOWN': {'value': 1}, 'IFINDEX': {'value': 2}, 'SYSTEM_PORT_NUMBER': {'value': 3}},), is_leaf=True, yang_name="interface-number-subtype", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='oc-lldp-types:mgmt-interface-number-subtype', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['lldp', 'mgmt-addresses', 'mgmt-address', 'state']

  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /lldp/mgmt_addresses/mgmt_address/state/address (union)

    YANG Description: Management address associated with the Management Address
TLV.
    """
  ...
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /lldp/mgmt_addresses/mgmt_address/state/address (union)
    If this variable is read-only (config: false) in the
...
TLV.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=[RestrictedClassType(base_type=str, restriction_dict={'pattern': '([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])(\\.([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])){3}'}),RestrictedClassType(base_type=str, restriction_dict={'pattern': '(([0-9a-fA-F]{1,4}:){7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:))'}),RestrictedClassType(base_type=str, restriction_dict={'pattern': '[0-9a-fA-F]{2}(:[0-9a-fA-F]{2}){5}'}),], is_leaf=True, yang_name="address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='union', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """address must be of a type compatible with union""",
          'defined-type': "openconfig-lldp:union",
          'generated-type': """YANGDynClass(base=[RestrictedClassType(base_type=str, restriction_dict={'pattern': '([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])(\\.([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])){3}'}),RestrictedClassType(base_type=str, restriction_dict={'pattern': '(([0-9a-fA-F]{1,4}:){7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:))'}),RestrictedClassType(base_type=str, restriction_dict={'pattern': '[0-9a-fA-F]{2}(:[0-9a-fA-F]{2}){5}'}),], is_leaf=True, yang_name="address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='union', is_config=False)""",
        })
  ...
  def _get_interface_number(self):
    """
    Getter method for interface_number, mapped from YANG variable /lldp/mgmt_addresses/mgmt_address/state/interface_number (uint32)

    YANG Description: Interface number that identifies the specific interface
associated with this management address.
    """
    return self.__interface_number
      
  def _set_interface_number(self, v, load=False):
    """
    Setter method for interface_number, mapped from YANG variable /lldp/mgmt_addresses/mgmt_address/state/interface_number (uint32)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_interface_number is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_interface_number() directly.
...
associated with this management address.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="interface-number", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='uint32', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """interface_number must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="interface-number", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='uint32', is_config=False)""",
        })

    self.__interface_number = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_interface_number(self):
    self.__interface_number = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="interface-number", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='uint32', is_config=False)


  def _get_interface_number_subtype(self):
    """
    Getter method for interface_number_subtype, mapped from YANG variable /lldp/mgmt_addresses/mgmt_address/state/interface_number_subtype (oc-lldp-types:mgmt-interface-number-subtype)

    YANG Description: The Management address interface numbering subtype field
indicating the numbering method used for defining the
interface-number.
    """
    return self.__interface_number_subtype
      
  def _set_interface_number_subtype(self, v, load=False):
    """
    Setter method for interface_number_subtype, mapped from YANG variable /lldp/mgmt_addresses/mgmt_address/state/interface_number_subtype (oc-lldp-types:mgmt-interface-number-subtype)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_interface_number_subtype is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_interface_number_subtype() directly.
...
interface-number.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=str,                                     restriction_type="dict_key",                                     restriction_arg={'UNKNOWN': {'value': 1}, 'IFINDEX': {'value': 2}, 'SYSTEM_PORT_NUMBER': {'value': 3}},), is_leaf=True, yang_name="interface-number-subtype", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='oc-lldp-types:mgmt-interface-number-subtype', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """interface_number_subtype must be of a type compatible with oc-lldp-types:mgmt-interface-number-subtype""",
          'defined-type': "oc-lldp-types:mgmt-interface-number-subtype",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=str,                                     restriction_type="dict_key",                                     restriction_arg={'UNKNOWN': {'value': 1}, 'IFINDEX': {'value': 2}, 'SYSTEM_PORT_NUMBER': {'value': 3}},), is_leaf=True, yang_name="interface-number-subtype", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='oc-lldp-types:mgmt-interface-number-subtype', is_config=False)""",
        })

    self.__interface_number_subtype = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_interface_number_subtype(self):
    self.__interface_number_subtype = YANGDynClass(base=RestrictedClassType(base_type=str,                                     restriction_type="dict_key",                                     restriction_arg={'UNKNOWN': {'value': 1}, 'IFINDEX': {'value': 2}, 'SYSTEM_PORT_NUMBER': {'value': 3}},), is_leaf=True, yang_name="interface-number-subtype", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='oc-lldp-types:mgmt-interface-number-subtype', is_config=False)

  address = __builtin__.property(_get_address)
  interface_number = __builtin__.property(_get_interface_number)
  interface_number_subtype = __builtin__.property(_get_interface_number_subtype)


  _pyangbind_elements = OrderedDict([('address', address), ('interface_number', interface_number), ('interface_number_subtype', interface_number_subtype), ])


class yc_mgmt_address_openconfig_lldp__lldp_mgmt_addresses_mgmt_address(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-lldp - based on the path /lldp/mgmt-addresses/mgmt-address. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: List of management addresses in use by the local/remote
system
  """
  __slots__ = ('_path_helper', '_extmethods', '__address','__state',)

  _yang_name = 'mgmt-address'
  _yang_namespace = 'http://openconfig.net/yang/lldp'
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__address = YANGDynClass(base=str, is_leaf=True, yang_name="address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='leafref', is_config=False)
    self.__state = YANGDynClass(base=yc_state_openconfig_lldp__lldp_mgmt_addresses_mgmt_address_state, is_container='container', yang_name="state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='container', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['lldp', 'mgmt-addresses', 'mgmt-address']

  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /lldp/mgmt_addresses/mgmt_address/address (leafref)

    YANG Description: Reference to the management address key
    """
    return self.__address
      
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /lldp/mgmt_addresses/mgmt_address/address (leafref)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_address is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_address() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=str, is_leaf=True, yang_name="address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='leafref', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """address must be of a type compatible with leafref""",
          'defined-type': "leafref",
          'generated-type': """YANGDynClass(base=str, is_leaf=True, yang_name="address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='leafref', is_config=False)""",
        })
  ...
  def _get_state(self):
    """
    Getter method for state, mapped from YANG variable /lldp/mgmt_addresses/mgmt_address/state (container)
  ...
  def _set_state(self, v, load=False):
    """
    Setter method for state, mapped from YANG variable /lldp/mgmt_addresses/mgmt_address/state (container)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_state_openconfig_lldp__lldp_mgmt_addresses_mgmt_address_state, is_container='container', yang_name="state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='container', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """state must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=yc_state_openconfig_lldp__lldp_mgmt_addresses_mgmt_address_state, is_container='container', yang_name="state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='container', is_config=False)""",
        })
...
class yc_mgmt_addresses_openconfig_lldp__lldp_mgmt_addresses(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-lldp - based on the path /lldp/mgmt-addresses. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Encapsulating container for management addresses
  """
  __slots__ = ('_path_helper', '_extmethods', '__mgmt_address',)

  _yang_name = 'mgmt-addresses'
  _yang_namespace = 'http://openconfig.net/yang/lldp'
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__mgmt_address = YANGDynClass(base=YANGListType("address",yc_mgmt_address_openconfig_lldp__lldp_mgmt_addresses_mgmt_address, yang_name="mgmt-address", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='address', extensions=None), is_container='list', yang_name="mgmt-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='list', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['lldp', 'mgmt-addresses']

  def _get_mgmt_address(self):
    """
    Getter method for mgmt_address, mapped from YANG variable /lldp/mgmt_addresses/mgmt_address (list)

    YANG Description: List of management addresses in use by the local/remote
system
    """
    return self.__mgmt_address
      
  def _set_mgmt_address(self, v, load=False):
    """
    Setter method for mgmt_address, mapped from YANG variable /lldp/mgmt_addresses/mgmt_address (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_mgmt_address is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_mgmt_address() directly.
...
system
    ...
    try:
      ...
      raise ValueError({
          'error-string': """mgmt_address must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("address",yc_mgmt_address_openconfig_lldp__lldp_mgmt_addresses_mgmt_address, yang_name="mgmt-address", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='address', extensions=None), is_container='list', yang_name="mgmt-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='list', is_config=False)""",
        })

    self.__mgmt_address = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_mgmt_address(self):
    self.__mgmt_address = YANGDynClass(base=YANGListType("address",yc_mgmt_address_openconfig_lldp__lldp_mgmt_addresses_mgmt_address, yang_name="mgmt-address", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='address', extensions=None), is_container='list', yang_name="mgmt-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='list', is_config=False)

  mgmt_address = __builtin__.property(_get_mgmt_address)


  _pyangbind_elements = OrderedDict([('mgmt_address', mgmt_address), ])
...
class yc_counters_openconfig_lldp__lldp_interfaces_interface_state_counters(PybindBase):
  ...
  def _get_frame_in(self):
    """
    Getter method for frame_in, mapped from YANG variable /lldp/interfaces/interface/state/counters/frame_in (oc-yang:counter64)
  ...
  def _set_frame_in(self, v, load=False):
    """
    Setter method for frame_in, mapped from YANG variable /lldp/interfaces/interface/state/counters/frame_in (oc-yang:counter64)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_frame_in is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_frame_in() directly.
  ...
  def _get_frame_out(self):
    """
    Getter method for frame_out, mapped from YANG variable /lldp/interfaces/interface/state/counters/frame_out (oc-yang:counter64)
  ...
  def _set_frame_out(self, v, load=False):
    """
    Setter method for frame_out, mapped from YANG variable /lldp/interfaces/interface/state/counters/frame_out (oc-yang:counter64)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_frame_out is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_frame_out() directly.
  ...
  def _get_frame_error_in(self):
    """
    Getter method for frame_error_in, mapped from YANG variable /lldp/interfaces/interface/state/counters/frame_error_in (oc-yang:counter64)
  ...
  def _set_frame_error_in(self, v, load=False):
    """
    Setter method for frame_error_in, mapped from YANG variable /lldp/interfaces/interface/state/counters/frame_error_in (oc-yang:counter64)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_frame_error_in is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_frame_error_in() directly.
  ...
  def _get_frame_discard(self):
    """
    Getter method for frame_discard, mapped from YANG variable /lldp/interfaces/interface/state/counters/frame_discard (oc-yang:counter64)
  ...
  def _set_frame_discard(self, v, load=False):
    """
    Setter method for frame_discard, mapped from YANG variable /lldp/interfaces/interface/state/counters/frame_discard (oc-yang:counter64)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_frame_discard is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_frame_discard() directly.
  ...
  def _get_tlv_discard(self):
    """
    Getter method for tlv_discard, mapped from YANG variable /lldp/interfaces/interface/state/counters/tlv_discard (oc-yang:counter64)
  ...
  def _set_tlv_discard(self, v, load=False):
    """
    Setter method for tlv_discard, mapped from YANG variable /lldp/interfaces/interface/state/counters/tlv_discard (oc-yang:counter64)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_tlv_discard is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_tlv_discard() directly.
  ...
  def _get_tlv_unknown(self):
    """
    Getter method for tlv_unknown, mapped from YANG variable /lldp/interfaces/interface/state/counters/tlv_unknown (oc-yang:counter64)
  ...
  def _set_tlv_unknown(self, v, load=False):
    """
    Setter method for tlv_unknown, mapped from YANG variable /lldp/interfaces/interface/state/counters/tlv_unknown (oc-yang:counter64)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_tlv_unknown is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_tlv_unknown() directly.
  ...
  def _get_last_clear(self):
    """
    Getter method for last_clear, mapped from YANG variable /lldp/interfaces/interface/state/counters/last_clear (oc-yang:date-and-time)
...
cleared.
  ...
  def _set_last_clear(self, v, load=False):
    """
    Setter method for last_clear, mapped from YANG variable /lldp/interfaces/interface/state/counters/last_clear (oc-yang:date-and-time)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_last_clear is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_last_clear() directly.
...
cleared.
  ...
  def _get_frame_error_out(self):
    """
    Getter method for frame_error_out, mapped from YANG variable /lldp/interfaces/interface/state/counters/frame_error_out (oc-yang:counter64)
...
interface.
  ...
  def _set_frame_error_out(self, v, load=False):
    """
    Setter method for frame_error_out, mapped from YANG variable /lldp/interfaces/interface/state/counters/frame_error_out (oc-yang:counter64)
    If this variable is read-only (config: false) in the
...
interface.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """frame_error_out must be of a type compatible with oc-yang:counter64""",
          'defined-type': "oc-yang:counter64",
...
class yc_state_openconfig_lldp__lldp_interfaces_interface_neighbors_neighbor_state(PybindBase):
  ...
  YANG Description: Operational state data 
  """
  __slots__ = ('_path_helper', '_extmethods', '__system_name','__system_description','__chassis_id','__chassis_id_type','__management_interface','__id','__age','__last_update','__ttl','__port_id','__port_id_type','__port_description','__management_address','__management_address_type',)
...
LldpChassisIdSubtype object from IEEE 802.1AB MIB.
  ...
  def _get_management_interface(self):
    """
    Getter method for management_interface, mapped from YANG variable /lldp/interfaces/interface/neighbors/neighbor/state/management_interface (oc-if:interface-id)
...
choose which interface is utilized.
  ...
  def _set_management_interface(self, v, load=False):
    """
    Setter method for management_interface, mapped from YANG variable /lldp/interfaces/interface/neighbors/neighbor/state/management_interface (oc-if:interface-id)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_management_interface is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_management_interface() directly.
...
specification.
  ...
  _pyangbind_elements = OrderedDict([('system_name', system_name), ('system_description', system_description), ('chassis_id', chassis_id), ('chassis_id_type', chassis_id_type), ('management_interface', management_interface), ('id', id), ('age', age), ('last_update', last_update), ('ttl', ttl), ('port_id', port_id), ('port_id_type', port_id_type), ('port_description', port_description), ('management_address', management_address), ('management_address_type', management_address_type), ])


class yc_state_openconfig_lldp__lldp_interfaces_interface_neighbors_neighbor_mgmt_addresses_mgmt_address_state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-lldp - based on the path /lldp/interfaces/interface/neighbors/neighbor/mgmt-addresses/mgmt-address/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['lldp', 'interfaces', 'interface', 'neighbors', 'neighbor', 'mgmt-addresses', 'mgmt-address', 'state']

  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /lldp/interfaces/interface/neighbors/neighbor/mgmt_addresses/mgmt_address/state/address (union)
...
TLV.
  ...
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /lldp/interfaces/interface/neighbors/neighbor/mgmt_addresses/mgmt_address/state/address (union)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_address is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_address() directly.
...
TLV.
  ...
  def _get_interface_number(self):
    """
    Getter method for interface_number, mapped from YANG variable /lldp/interfaces/interface/neighbors/neighbor/mgmt_addresses/mgmt_address/state/interface_number (uint32)
...
associated with this management address.
  ...
  def _set_interface_number(self, v, load=False):
    """
    Setter method for interface_number, mapped from YANG variable /lldp/interfaces/interface/neighbors/neighbor/mgmt_addresses/mgmt_address/state/interface_number (uint32)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_interface_number is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_interface_number() directly.
...
associated with this management address.
  ...
  def _get_interface_number_subtype(self):
    """
    Getter method for interface_number_subtype, mapped from YANG variable /lldp/interfaces/interface/neighbors/neighbor/mgmt_addresses/mgmt_address/state/interface_number_subtype (oc-lldp-types:mgmt-interface-number-subtype)
...
interface-number.
  ...
  def _set_interface_number_subtype(self, v, load=False):
    """
    Setter method for interface_number_subtype, mapped from YANG variable /lldp/interfaces/interface/neighbors/neighbor/mgmt_addresses/mgmt_address/state/interface_number_subtype (oc-lldp-types:mgmt-interface-number-subtype)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_interface_number_subtype is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_interface_number_subtype() directly.
...
class yc_mgmt_address_openconfig_lldp__lldp_interfaces_interface_neighbors_neighbor_mgmt_addresses_mgmt_address(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-lldp - based on the path /lldp/interfaces/interface/neighbors/neighbor/mgmt-addresses/mgmt-address. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
...
system
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__address = YANGDynClass(base=str, is_leaf=True, yang_name="address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='leafref', is_config=False)
    self.__state = YANGDynClass(base=yc_state_openconfig_lldp__lldp_interfaces_interface_neighbors_neighbor_mgmt_addresses_mgmt_address_state, is_container='container', yang_name="state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='container', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['lldp', 'interfaces', 'interface', 'neighbors', 'neighbor', 'mgmt-addresses', 'mgmt-address']

  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /lldp/interfaces/interface/neighbors/neighbor/mgmt_addresses/mgmt_address/address (leafref)
  ...
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /lldp/interfaces/interface/neighbors/neighbor/mgmt_addresses/mgmt_address/address (leafref)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_address is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_address() directly.
  ...
  def _get_state(self):
    """
    Getter method for state, mapped from YANG variable /lldp/interfaces/interface/neighbors/neighbor/mgmt_addresses/mgmt_address/state (container)
  ...
  def _set_state(self, v, load=False):
    """
    Setter method for state, mapped from YANG variable /lldp/interfaces/interface/neighbors/neighbor/mgmt_addresses/mgmt_address/state (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_state is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_state() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_state_openconfig_lldp__lldp_interfaces_interface_neighbors_neighbor_mgmt_addresses_mgmt_address_state, is_container='container', yang_name="state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='container', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """state must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=yc_state_openconfig_lldp__lldp_interfaces_interface_neighbors_neighbor_mgmt_addresses_mgmt_address_state, is_container='container', yang_name="state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='container', is_config=False)""",
        })
...
class yc_mgmt_addresses_openconfig_lldp__lldp_interfaces_interface_neighbors_neighbor_mgmt_addresses(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-lldp - based on the path /lldp/interfaces/interface/neighbors/neighbor/mgmt-addresses. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__mgmt_address = YANGDynClass(base=YANGListType("address",yc_mgmt_address_openconfig_lldp__lldp_interfaces_interface_neighbors_neighbor_mgmt_addresses_mgmt_address, yang_name="mgmt-address", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='address', extensions=None), is_container='list', yang_name="mgmt-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='list', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['lldp', 'interfaces', 'interface', 'neighbors', 'neighbor', 'mgmt-addresses']

  def _get_mgmt_address(self):
    """
    Getter method for mgmt_address, mapped from YANG variable /lldp/interfaces/interface/neighbors/neighbor/mgmt_addresses/mgmt_address (list)
...
system
  ...
  def _set_mgmt_address(self, v, load=False):
    """
    Setter method for mgmt_address, mapped from YANG variable /lldp/interfaces/interface/neighbors/neighbor/mgmt_addresses/mgmt_address (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_mgmt_address is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_mgmt_address() directly.
...
class yc_neighbor_openconfig_lldp__lldp_interfaces_interface_neighbors_neighbor(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__id','__state','__mgmt_addresses','__custom_tlvs','__capabilities',)
  ...
  def _get_mgmt_addresses(self):
    """
    Getter method for mgmt_addresses, mapped from YANG variable /lldp/interfaces/interface/neighbors/neighbor/mgmt_addresses (container)

    YANG Description: Encapsulating container for management addresses
    """
    return self.__mgmt_addresses
      
  def _set_mgmt_addresses(self, v, load=False):
    """
    Setter method for mgmt_addresses, mapped from YANG variable /lldp/interfaces/interface/neighbors/neighbor/mgmt_addresses (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_mgmt_addresses is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_mgmt_addresses() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_mgmt_addresses_openconfig_lldp__lldp_interfaces_interface_neighbors_neighbor_mgmt_addresses, is_container='container', yang_name="mgmt-addresses", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='container', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """mgmt_addresses must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=yc_mgmt_addresses_openconfig_lldp__lldp_interfaces_interface_neighbors_neighbor_mgmt_addresses, is_container='container', yang_name="mgmt-addresses", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='container', is_config=False)""",
        })

    self.__mgmt_addresses = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_mgmt_addresses(self):
    self.__mgmt_addresses = YANGDynClass(base=yc_mgmt_addresses_openconfig_lldp__lldp_interfaces_interface_neighbors_neighbor_mgmt_addresses, is_container='container', yang_name="mgmt-addresses", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='container', is_config=False)
...
neighbor
  ...
  _pyangbind_elements = OrderedDict([('id', id), ('state', state), ('mgmt_addresses', mgmt_addresses), ('custom_tlvs', custom_tlvs), ('capabilities', capabilities), ])
...
class yc_lldp_openconfig_lldp__lldp(PybindBase):
  ...
  def _get_mgmt_addresses(self):
    """
    Getter method for mgmt_addresses, mapped from YANG variable /lldp/mgmt_addresses (container)
  ...
  def _set_mgmt_addresses(self, v, load=False):
    """
    Setter method for mgmt_addresses, mapped from YANG variable /lldp/mgmt_addresses (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_mgmt_addresses is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_mgmt_addresses() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_mgmt_addresses_openconfig_lldp__lldp_mgmt_addresses, is_container='container', yang_name="mgmt-addresses", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='container', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """mgmt_addresses must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=yc_mgmt_addresses_openconfig_lldp__lldp_mgmt_addresses, is_container='container', yang_name="mgmt-addresses", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='http://openconfig.net/yang/lldp', defining_module='openconfig-lldp', yang_type='container', is_config=False)""",
        })
