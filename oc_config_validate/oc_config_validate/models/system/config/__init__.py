...
class config(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__domain_name','__login_banner','__motd_banner',)
...
last login timestamp, etc.
  ...
  _pyangbind_elements = OrderedDict([('domain_name', domain_name), ('login_banner', login_banner), ('motd_banner', motd_banner), ])
