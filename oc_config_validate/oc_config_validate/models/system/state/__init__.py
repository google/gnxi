...
class state(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__domain_name','__login_banner','__motd_banner','__current_datetime','__boot_time',)
...
to the Unix Epoch (Jan 1, 1970 00:00:00 UTC).
  ...
  _pyangbind_elements = OrderedDict([('domain_name', domain_name), ('login_banner', login_banner), ('motd_banner', motd_banner), ('current_datetime', current_datetime), ('boot_time', boot_time), ])
