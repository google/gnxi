...
class openconfig_aft_global_filter(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-aft-global-filter - based on the path /openconfig-aft-global-filter. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Module containing definitions of groupings for the global
...
class openconfig_aft_counters(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-aft-counters - based on the path /openconfig-aft-counters. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Submodule providing a unified subtree for AFT entry counters.
  """
  _pyangbind_elements = {}
