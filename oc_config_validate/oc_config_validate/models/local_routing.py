...
class openconfig_local_routing_network_instance(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-local-routing-network-instance - based on the path /openconfig-local-routing-network-instance. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: This module adds leaves that relate to network-instances
