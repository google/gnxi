...
# This wipes the folder clean every time, so ALL models must be regenerated below
rm -fr ${MODELS_FOLDER}/*
...
cp /usr/local/google/home/villalobosrr/Downloads/arista-wifi-augments.yang ${MODELS_PATH}/wifi/arista-wifi-augments.yang
...
# 3. Create custom wifi_aruba that includes Aruba vendor augments
cp /usr/local/google/home/villalobosrr/Downloads/aruba-wifi-augments.yang ${MODELS_PATH}/wifi/aruba-wifi-augments.yang
for m in $( ls -d ${MODELS_PATH}/wifi/ ); do
